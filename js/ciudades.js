...
function getCiudades() {
     ...
     $.getJSON('http://apps.sbiweb.com/HOTFEST/CiudadJsonServlet.json', function(data) {
        ...
        $('#ciudadesSection ul').append('<li class="arrow"><a href="listeventos.html?ciudadId=' + ciudad.CiudadId + '" data-ajax="false"><div class="categoriaL categoriaID'+ ciudadades.CiudadId +'">'+
